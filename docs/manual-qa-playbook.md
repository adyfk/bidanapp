...
This is the fastest path to a repeatable local manual QA pass against the seeded BidanApp runtime.

Use this document when you need one entrypoint that combines setup, seeded QA accounts, suggested routes, and per-case validation focus.
...
- [Seed Data Blueprint](./seed-data/README.md) for the normalized QA seed model behind the operational scenarios
