...
const portraitBackgrounds = [
  'linear-gradient(180deg,#ffe6f1 0%,#fff5fa 100%)',
  'linear-gradient(180deg,#ffe1ef 0%,#fff4fb 100%)',
  'linear-gradient(180deg,#fde3ff 0%,#fff5ff 100%)',
];
...
export function InitialPortrait({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-[#fdebf5] via-[#fdebf5]/72 to-transparent" />
