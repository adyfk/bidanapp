...
export const AppointmentDetailSheet = ({
  ...
  const statusBanner = SIMULATION_MESSAGES.appointmentStatusBanners[appointment.status];
        ...
        <div className="mb-4 flex items-center justify-between rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[12px] font-bold text-green-500">{SIMULATION_SHARED.onlineStatusLabel}</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-2 flex items-center justify-between border-t border-gray-50 pt-4">
              <p className="text-[13px] font-bold text-gray-500">
                {SIMULATION_MESSAGES.appointmentFieldLabels.totalPayment}
              </p>
