        ...
        <div className="flex items-center gap-1 -ml-2">
          ...
          >
            ...
            <div className="flex flex-col flex-1 min-w-0 pr-2">
              ...
              <span className="text-[12px] text-green-500 font-medium leading-none mt-1">{SIMULATION_SHARED.onlineStatusLabel}</span>
            </div>
          </div>
        </div>
        ...
        {messages.map((msg) => {
          ...
          return (
            <div key={msg.id} className={`flex w-full ${isUser ? 'justify-end' : 'justify-start'}`}>
              <div
                className={`max-w-[75%] px-4 py-2.5 rounded-[20px] relative shadow-sm ${isUser
