...
docker build -f apps/frontend/Dockerfile \
  ...
  --build-arg NEXT_PUBLIC_PROFESSIONAL_PORTAL_DATA_SOURCE="$NEXT_PUBLIC_PROFESSIONAL_PORTAL_DATA_SOURCE" \
  --build-arg NEXT_PUBLIC_APP_STATE_DATA_SOURCE="$NEXT_PUBLIC_APP_STATE_DATA_SOURCE" \
