  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 pb-24 relative overflow-y-auto custom-scrollbar">
      ...
      <div className="px-5 py-6">
        ...
        {/* Logout */}
        <button className="mt-8 w-full flex items-center justify-center gap-2 p-4 bg-red-50 text-red-500 rounded-2xl font-bold active:bg-red-100 transition-colors shadow-sm">
